...
namespace Budget_Buddy_Expense_and_Debt_Tracker.Components.Model
{
    internal class TransactionPerson
    {
        ...
        // Constructor
        public TransactionPerson(string title, double amount, string transactionType, string tag, DateTime date, string note, DateTime? dueDate = null, string source = null)
        {
            Title = title;
            Amount = amount;
